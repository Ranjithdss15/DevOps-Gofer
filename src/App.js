...
function App() {
  ...
  useEffect(()=>{
      ...
      fetch("/DevOps-Gofer/master/dump.json")
        .then(res => res.json())
        .then(
          (result) => {
            if(result) {
      ...
      <div className="app-wrapper">
        <div className="app-container">
          ...
          <div className="view-sample-block">
            <a href="https://github.com/kalaiarasan33/DevOps-Gofer/blob/master/dump.json" target="_blank" className="tf-sample-link" rel="noopener noreferrer">Download Template Dump</a>
          </div>
